...
> **Administrator provisioning:** An operator must provision the first administrator with the explicit production bootstrap command. No default credentials are committed.
