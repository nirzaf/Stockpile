...
namespace Merconiq.Infrastructure.Migrations
{
    ...
    [Migration("20260918070000_AddTransferTransitReceipts")]
    partial class AddTransferTransitReceipts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.TransferTransitReceipt", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TransferTransitReceipts", null, t =>
                        {
                            t.HasCheckConstraint("CK_TransferTransitReceipts_NonNegativeRemainder", "\"RemainingQuantity\" >= 0 AND \"RemainingValue\" >= 0");

                            t.HasCheckConstraint("CK_TransferTransitReceipts_NonNegativeValue", "\"UnitCost\" >= 0 AND \"TotalValue\" >= 0");

                            t.HasCheckConstraint("CK_TransferTransitReceipts_PositiveQuantity", "\"Quantity\" > 0");
                        });
                });
