...
namespace Merconiq.Infrastructure.Migrations
{
    ...
    [Migration("20260918213252_AddPurchaseOrderLineObligations")]
    partial class AddPurchaseOrderLineObligations
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.StockCount", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MovementWatermark")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "LocationId", "SnapshotAtUtc");

                    b.ToTable("StockCounts");
                });

            modelBuilder.Entity("Merconiq.Core.Entities.StockCountLine", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StockCountId", "TenantId");

                    b.ToTable("StockCountLines", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockCountLines_SnapshotQuantity", "\"SnapshotQuantity\" >= 0");
                        });
                });

            modelBuilder.Entity("Merconiq.Core.Entities.StockCountObservation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("StockCountLineId", "TenantId")
                        .IsUnique();

                    b.ToTable("StockCountObservations", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockCountObservations_CountedQuantity", "\"CountedQuantity\" >= 0");
                        });
                });

            modelBuilder.Entity("Merconiq.Core.Entities.StockCountVariance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<decimal?>("ApprovedUnitCost")
                        .HasColumnType("decimal(18,6)");
                    ...
                    b.Property<int>("ExpectedCurrentQuantity")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("StockCountVariances", null, t =>
                        {
                            t.HasCheckConstraint("CK_StockCountVariances_ApprovedUnitCost", "\"ApprovedUnitCost\" IS NULL OR \"ApprovedUnitCost\" >= 0");

                            t.HasCheckConstraint("CK_StockCountVariances_Quantities", "\"ExpectedCurrentQuantity\" >= 0 AND \"CountedQuantity\" >= 0 AND \"DeltaQuantity\" = \"CountedQuantity\" - \"ExpectedCurrentQuantity\"");

                            t.HasCheckConstraint("CK_StockCountVariances_Reason", "length(trim(\"Reason\")) > 0");
                        });
                });
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.TransferOrderLine", b =>
                {
                    ...
                    b.ToTable("TransferOrderLines", null, t =>
                        {
                            t.HasCheckConstraint("CK_TransferOrderLines_DispatchedQuantity", "\"DispatchedQuantity\" >= 0 AND \"DispatchedQuantity\" <= \"Quantity\"");

                            t.HasCheckConstraint("CK_TransferOrderLines_PositiveQuantity", "\"Quantity\" > 0");
                        });
                });

            modelBuilder.Entity("Merconiq.Core.Entities.TransferTransitEntry", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("SourceDocumentLineId", "TenantId");
                    ...
                    b.HasIndex("TransferOrderLineId", "TenantId");

                    b.HasIndex("TenantId", "TransferOrderId", "DispatchedAt");

                    b.HasIndex("TenantId", "TransferOrderLineId", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("TransferTransitEntries", null, t =>
                        {
                            t.HasCheckConstraint("CK_TransferTransitEntries_NonNegativeValue", "\"UnitCost\" >= 0 AND \"TotalValue\" >= 0");

                            t.HasCheckConstraint("CK_TransferTransitEntries_PositiveQuantity", "\"Quantity\" > 0");
                        });
                });

            modelBuilder.Entity("Merconiq.Core.Entities.TransferTransitSettlement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("TransferTransitEntryId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TenantId", "DocumentLineId")
                        .IsUnique()
                    ...
                    b.HasIndex("TransferTransitEntryId", "TenantId");

                    b.HasIndex("DocumentId", "DocumentLineId", "TenantId")
                        .IsUnique();

                    b.HasIndex("TenantId", "TransferOrderId", "SettledAt");

                    b.HasIndex("TenantId", "TransferTransitEntryId", "IdempotencyKey")
                        .IsUnique();

                    b.ToTable("TransferTransitSettlements", null, t =>
                        {
                            t.HasCheckConstraint("CK_TransferTransitSettlements_DocumentIdentityPair", "(\"DocumentId\" IS NULL AND \"DocumentLineId\" IS NULL) OR (\"DocumentId\" IS NOT NULL AND \"DocumentLineId\" IS NOT NULL)");
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.StockCountLine", b =>
                {
                    ...
                    b.HasOne("Merconiq.Core.Entities.StockCount", "StockCount")
                        .WithMany("Lines")
                        .HasForeignKey("StockCountId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.StockCountObservation", b =>
                {
                    b.HasOne("Merconiq.Core.Entities.StockCountLine", "StockCountLine")
                        .WithOne("Observation")
                        .HasForeignKey("Merconiq.Core.Entities.StockCountObservation", "StockCountLineId", "TenantId")
                        .HasPrincipalKey("Merconiq.Core.Entities.StockCountLine", "Id", "TenantId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("StockCountLine");
                });
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.StockCountVariance", b =>
                {
                    b.HasOne("Merconiq.Core.Entities.StockCountLine", "StockCountLine")
                        .WithOne("Variance")
                        .HasForeignKey("Merconiq.Core.Entities.StockCountVariance", "StockCountLineId", "TenantId")
                        .HasPrincipalKey("Merconiq.Core.Entities.StockCountLine", "Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.TransferTransitEntry", b =>
                {
                    ...
                    b.HasOne("Merconiq.Core.Entities.Item", null)
                        .WithMany()
                        .HasForeignKey("ItemId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.HasOne("Merconiq.Core.Entities.DocumentLineIdentity", null)
                        .WithMany()
                        .HasForeignKey("SourceDocumentLineId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Merconiq.Core.Entities.StockTransaction", null)
                        .WithMany()
                        .HasForeignKey("StockTransactionId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.HasOne("Merconiq.Core.Entities.TransferOrder", null)
                        .WithMany()
                        .HasForeignKey("TransferOrderId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                    ...
                    b.HasOne("Merconiq.Core.Entities.TransferOrderLine", null)
                        .WithMany()
                        .HasForeignKey("TransferOrderLineId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Merconiq.Core.Entities.TransferTransitSettlement", b =>
                {
                    ...
                    b.HasOne("Merconiq.Core.Entities.DocumentIdentity", "DocumentIdentity")
                        .WithOne()
                        .HasForeignKey("Merconiq.Core.Entities.TransferTransitSettlement", "DocumentId", "TenantId")
                        .HasPrincipalKey("Merconiq.Core.Entities.DocumentIdentity", "Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.HasOne("Merconiq.Core.Entities.TransferTransitEntry", null)
                        .WithMany()
                        .HasForeignKey("TransferTransitEntryId", "TenantId")
                        .HasPrincipalKey("Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("Merconiq.Core.Entities.DocumentLineIdentity", "DocumentLineIdentity")
                        .WithOne()
                        .HasForeignKey("Merconiq.Core.Entities.TransferTransitSettlement", "DocumentId", "DocumentLineId", "TenantId")
                        .HasPrincipalKey("Merconiq.Core.Entities.DocumentLineIdentity", "DocumentId", "Id", "TenantId")
                        .OnDelete(DeleteBehavior.Restrict);
