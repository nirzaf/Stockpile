...
public interface IStockService
{
    ...
    /// <summary>Adds a valued receipt from existing in-transit stock inside its owning transfer transaction.</summary>
    Task<StockTransaction> ReceiveTransferTransitAsync(
        int itemId,
        int fromLocationId,
        int toLocationId,
        int quantity,
